...
const ruleBlocks = [
  ...
  },
  {
    ...
    lead: 'Предупреждения фиксируются отдельно от очков, а штрафы сразу влияют на общий счет.',
    items: [
      'Предупреждение не меняет очки игрока.',
      'Каждый штраф вычитает 250 очков из общего счета игрока.',
      'Ошибочно выданный штраф можно снять до сохранения партии.'
    ]
  }
];
