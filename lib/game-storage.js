...
function buildScoresPayload(players, rounds) {
...
function parseScoresPayload(rawScores, players) {
  if (!rawScores) {
    return {
      rounds: {},
...
export function serializeGame(game) {
  ...
  const { rounds, protocol } = parseScoresPayload(game.scoresJson, players);
